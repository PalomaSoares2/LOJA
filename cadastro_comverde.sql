...
--
-- Dumping data for table `comverde`
--

LOCK TABLES `comverde` WRITE;
/*!40000 ALTER TABLE `comverde` DISABLE KEYS */;
/*!40000 ALTER TABLE `comverde` ENABLE KEYS */;
UNLOCK TABLES;
